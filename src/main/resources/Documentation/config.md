...
plugin.@PLUGIN@.deleteTrashFoldersTimeoutMinutes
: Maximum duration, in minutes, to delete trash folders.

	Specifies the maximum duration, in minutes, that the plugin will spend
