...
public class DatabaseDeleteHandler {
  ...
  public void delete(Project project) throws IOException {
    List<Change.Id> changesListFromNoteDb = getChangesListFromNoteDb(project);
    indexer.deleteAllForProject(project, changesListFromNoteDb);
    unstarChanges(changesListFromNoteDb);
