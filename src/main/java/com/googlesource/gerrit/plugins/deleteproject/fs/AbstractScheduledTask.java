...
public abstract class AbstractScheduledTask implements LifecycleListener, Runnable {
  ...
  private final long defaultInitialDelayMillis;
  private final long defaultPeriodDays;
  private ScheduledFuture<?> scheduledTask;
  private boolean oneShotIfNoSchedule;
  ...
  protected AbstractScheduledTask(
      ...
      long defaultPeriod,
      Boolean oneShotIfNoSchedule) {
    this.queue = queue;
    this.schedule = schedule;
    this.defaultInitialDelayMillis = defaultInitialDelay;
    this.defaultPeriodDays = defaultPeriod;
    this.oneShotIfNoSchedule = oneShotIfNoSchedule;
  }
  ...
  public void start() {
    ...
    if (schedule.isEmpty() && oneShotIfNoSchedule) {
      scheduledTask =
