...
public class ConfigurationTest {
  ...
  private static final long DEFAULT_DELETE_DURATION_S = 43200;
  ...
  public void defaultValuesAreLoaded() {
    ...
    assertThat(deleteConfig.gettDeleteProjectTimeDurationSeconds())
        .isEqualTo(DEFAULT_DELETE_DURATION_S);
  ...
  public void customValuesAreLoaded() {
    ...
    assertThat(deleteConfig.gettDeleteProjectTimeDurationSeconds())
        .isEqualTo(Long.parseLong(CUSTOM_DELETE_DURATION_HOURS) * 3600);
