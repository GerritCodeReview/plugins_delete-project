...
public class ConfigurationTest {
  ...
  private static final String INVALID_CUSTOM_FOLDER = "/mysite/data";
  ...
  public void defaultValuesAreLoaded() {
    ...
    assertThat(deleteConfig.getArchiveDuration())
        .isEqualTo(TimeUnit.DAYS.toMillis(Long.parseLong("180")));
    assertThat(deleteConfig.getArchiveFolder().toString())
        .isEqualTo(pluginDataDir.toFile().toString());
  }
  ...
  public void invalidTargetArchiveFolder() {
    PluginConfig pluginConfig = new PluginConfig(PLUGIN_NAME, new Config());
    pluginConfig.setString("targetArchiveFolder", INVALID_CUSTOM_FOLDER);
  ...
  public void invalidArchiveDuration() {
    PluginConfig pluginConfig = new PluginConfig(PLUGIN_NAME, new Config());
    pluginConfig.setString("archiveDuration", INVALID_ARCHIVE_DURATION);
